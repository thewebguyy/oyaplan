...
- **In-Memory Filtering**: `ForgeResultsClient` currently fetches all spots for an area and filters client/server-side. Will bottleneck at 1,000+ spots. Requires pagination or RPC functions.
